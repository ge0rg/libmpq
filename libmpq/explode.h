...
typedef struct {
	...
	uint32_t	(*read_buf)(int8_t *buf, uint32_t *size, void *param);	/* 0028 offset.*/
	void		(*write_buf)(int8_t *buf, uint32_t *size, void *param);	/* 002C offset. */
